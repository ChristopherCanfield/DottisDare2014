		...
		<div class="modal fade" id="purpleTriangle" tabindex="-1" role="dialog">
				...
				<div class="modal-content">					
					<div class="modal-body modal-body-clue">
						...
						<?php
							...
							{
								// Change the value at the end for each clue.
								$onSubmitValue = 'closeModalOpenTimeline(\'' . $troop . '\', \'' . $troopName . '\',\'purpleTriangle\');';
							}
							...
							'<img src="images/clues/' . $clueId . '.jpg" alt="Dotti\'s Tree" 
								width="314" height="228" class="img-rounded modal-image-clue" />';
