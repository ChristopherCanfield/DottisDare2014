		...
		<div class="modal fade" id="greenCircle" tabindex="-1" role="dialog" aria-labelledby="Green Circle" aria-hidden="true">
					...
					<div class="modal-body modal-body-clue">
						...
						<?php
							...
							if (!$clueFound)
							{
								...
								$onSubmitValue = 'validateClue(\'' . $troop . '\', ' . $clueId . ', \'greenCircle\');';
							}
							else
							{
								// Change the value at the end for each clue.
								$onSubmitValue = 'closeModalOpenTimeline(\'greenCircle\');';
							}
							...
							'<img src="images/clues/' . $clueId . '.jpg" alt="Ginder Barn" 
								width="314" height="229" class="img-rounded modal-image-clue" />';
