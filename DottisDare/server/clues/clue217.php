		...
		<div class="modal fade" id="redSquare" tabindex="-1" role="dialog" aria-labelledby="Red Square" aria-hidden="true">
					...
					<div class="modal-body modal-body-clue">
						...
						<?php
							...
							if (!$clueFound)
							{
								...
								$onSubmitValue = 'validateClue(\'' . $troop . '\', ' . $clueId . ', \'redSquare\');';
							}
							else
							{
								// Change the value at the end for each clue.
								$onSubmitValue = 'closeModalOpenTimeline(\'redSquare\');';
							}
							...
							'<img src="images/clues/' . $clueId . '.jpg" alt="Pennypack Picnic Tables" 
