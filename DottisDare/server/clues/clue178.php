		...
		<div class="modal fade" id="purpleCircle" tabindex="-1" role="dialog" aria-labelledby="Purple Circle" aria-hidden="true">
					...
					<div class="modal-body modal-body-clue">
						...
						<?php
							...
							if (!$clueFound)
							{
								...
								$onSubmitValue = 'validateClue(\'' . $troop . '\', ' . $clueId . ', \'purpleCircle\');';
							}
							else
							{
								// Change the value at the end for each clue.
								$onSubmitValue = 'closeModalOpenTimeline(\'purpleCircle\');';
							}
							...
							'<img src="images/clues/' . $clueId . '.jpg" alt="Birdhouse at Conestoga" 
								width="235" height="255" class="img-rounded modal-image-clue" />';
