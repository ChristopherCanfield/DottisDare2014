					...
					<div class="modal-body modal-body-clue">
						...
						<?php
							...
							if (!$clueFound)
							{
								...
								$onSubmitValue = 'validateClue(\'' . $troop . '\', ' . $clueId . ', \'greenSquare\');';
							}
							else
							{
								// Change the value at the end for each clue.
								$onSubmitValue = 'closeModalOpenTimeline(\'greenSquare\');';
							}
							...
							'<img src="images/clues/' . $clueId . '.jpg" alt="Murphy House" 
								width="235" height="258" class="img-rounded modal-image-clue" />';
