		...
		<div class="modal fade" id="purpleSquare" tabindex="-1" role="dialog" aria-labelledby="Purple Square" aria-hidden="true">
					...
					<div class="modal-body modal-body-clue">
						...
						<?php
							...
							if (!$clueFound)
							{
								...
								$onSubmitValue = 'validateClue(\'' . $troop . '\', ' . $clueId . ', \'purpleSquare\');';
							}
							else
							{
								// Change the value at the end for each clue.
								$onSubmitValue = 'closeModalOpenTimeline(\'purpleSquare\');';
							}
							...
							'<img src="images/clues/' . $clueId . '.jpg" alt="Shenango Sign" 
								width="235" height="245" class="img-rounded modal-image-clue" />';
