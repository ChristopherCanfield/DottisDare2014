		...
		<div class="modal fade" id="greenTriangle" tabindex="-1" role="dialog" aria-labelledby="Green Triangle" aria-hidden="true">
					...
					<div class="modal-body modal-body-clue">
						...
						<?php
							...
							if (!$clueFound)
							{
								...
								$onSubmitValue = 'validateClue(\'' . $troop . '\', ' . $clueId . ', \'greenTriangle\');';
							}
							else
							{
								// Change the value at the end for each clue.
								$onSubmitValue = 'closeModalOpenTimeline(\'greenTriangle\');';
							}
							...
							'<img src="images/clues/' . $clueId . '.jpg" alt="Tree at Conewago" 
