		...
		<div class="modal fade" id="blueSquare" tabindex="-1" role="dialog" aria-labelledby="Blue Square" aria-hidden="true">
					...
					<div class="modal-body modal-body-clue">
						...
						<?php
							...
							if (!$clueFound)
							{
								...
								$onSubmitValue = 'validateClue(\'' . $troop . '\', ' . $clueId . ', \'blueSquare\');';
							}
							else
							{
								// Change the value at the end for each clue.
								$onSubmitValue = 'closeModalOpenTimeline(\'blueSquare\');';
							}
							...
							'<img src="images/clues/' . $clueId . '.jpg" alt="Speed Limit Sign by Dining Hall" 
								width="161" height="314" class="img-rounded modal-image-clue" />';
