		...
		<div class="modal fade" id="blueCircle" tabindex="-1" role="dialog">
					...
					<div class="modal-body modal-body-clue">
						...
						<?php
							...
							if (!$clueFound)
							{
								...
								$onSubmitValue = 'validateClue(\'' . $troop . '\', ' . $clueId . ', \'blueCircle\');';
							}
							else
							{
								// Change the value at the end for each clue.
								$onSubmitValue = 'closeModalOpenTimeline(\'blueCircle\');';
							}
							...
							'<img src="images/clues/' . $clueId . '.jpg" alt="Eagle Bridge" 
								width="314" height="201" class="img-rounded modal-image-clue" />';
